...
import com.mydemo.marketdemo.MarketApp;
import com.mydemo.marketdemo.utils.CommonUtil;
...
public class RetrofitHelper
{
    ...
    {
        Cache cache = new Cache(new File(MarketApp.getInstance().getCacheDir(),
                HttpConstant.CACHE_DIR), HttpConstant.CACHE_SIZE);
        return cache;
    }
    ...
    private static class CacheInterceptor implements Interceptor
    {
        ...
        public Response intercept(Chain chain) throws IOException
        {
            ...
            if (CommonUtil.isNetworkAvailable(MarketApp.getInstance()))
            {
                //有网络时只从网络获取
